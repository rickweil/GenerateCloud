...
class ConsumablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consumable" do
    assert_difference('Consumable.count') do
      post consumables_url, params: { consumable: { expiration_date: @consumable.expiration_date, udi: @consumable.udi } }
    end
  ...
  test "should update consumable" do
    patch consumable_url(@consumable), params: { consumable: { expiration_date: @consumable.expiration_date, udi: @consumable.udi } }
